...
export const channels = {
  ...
  'music.generate': { input: z.object({ prompt: z.string().optional(), mood: z.string().nullable().optional(), tags: z.array(z.string()).optional(), durationMs: z.number().optional(), name: z.string().optional(), modelId: z.string().optional() }), output: MusicTrackSchema },
  ...
  'publish.build': { input: z.object({ projectId: z.string(), targetId: z.string(), strategy: ReframeStrategySchema.optional(), caption: z.string().optional(), hashtags: z.string().optional(), sound: TrendSoundSchema.nullable().optional(), musicGainDb: z.number().min(-30).max(6).optional(), outputDir: z.string().nullable().optional() }), output: PublishPackageSchema },

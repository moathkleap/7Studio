...
export const channels = {
  ...
  'publish.build': { input: z.object({ projectId: z.string(), targetId: z.string(), strategy: ReframeStrategySchema.optional(), caption: z.string().optional(), hashtags: z.string().optional(), sound: TrendSoundSchema.nullable().optional(), outputDir: z.string().nullable().optional() }), output: PublishPackageSchema },

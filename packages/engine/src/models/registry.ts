...
export const MODEL_REGISTRY: ModelSpec[] = [
  ...
  { id: 'musicgen/small', name: 'MusicGen Small (music)', capability: 'gen.music', providerId: 'musicgen', version: '1.0', kind: 'local', files: [
    { url: hf('facebook/musicgen-small', 'config.json'), path: 'config.json', sha256: null, sizeBytes: null },
    { url: hf('facebook/musicgen-small', 'generation_config.json'), path: 'generation_config.json', sha256: null, sizeBytes: null },
    { url: hf('facebook/musicgen-small', 'preprocessor_config.json'), path: 'preprocessor_config.json', sha256: null, sizeBytes: null },
    { url: hf('facebook/musicgen-small', 'tokenizer_config.json'), path: 'tokenizer_config.json', sha256: null, sizeBytes: null },
    { url: hf('facebook/musicgen-small', 'special_tokens_map.json'), path: 'special_tokens_map.json', sha256: null, sizeBytes: null },
    { url: hf('facebook/musicgen-small', 'spiece.model'), path: 'spiece.model', sha256: null, sizeBytes: null },
    { url: hf('facebook/musicgen-small', 'model.safetensors'), path: 'model.safetensors', sha256: null, sizeBytes: 2360000000 },
  ], sizeBytes: 2_360_000_000, vramMb: 4000, ramMb: 6000, requiresGpu: false, languages: [], license: 'CC-BY-NC-4.0', description: 'Local text-to-music generation for cleared background tracks (runs on CPU, faster with a GPU).', descriptionAr: 'توليد موسيقى محلي من نص لمقاطع خلفية مرخّصة (يعمل على المعالج، وأسرع مع معالج رسومي).', host: 'huggingface.co', recommended: 'optional' },
